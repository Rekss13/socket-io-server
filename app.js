...
const getApiAndEmit = socket => {
    const response = {
        ...
        "AUX": false,
        "songTitle": "Bad News",
        "songAuthor": "Gary Moore",
        "songAlbum": "Dirty Fingers",
        "songDuration": 303,
        "elapsed": Math.floor(Math.random() * 304),
        "random": false,
        "playback": Math.floor(Math.random() * 2) ? "stop" : "play",
        "sleep": false,
        "usbFolders": [],
        "lanFolders": [],
        "albumCover": "https://lastfm.freetls.fastly.net/i/u/300x300/5621513cd53d46e1c62a93861822cf4a.jpg",
        "indexing": false,
        "name": "URRI Receiver",
        "presets": [
            {
